...
export const articulos: Articulo[] = [
  ...
  {
    slug: "que-preguntar-antes-de-contratar-desarrollador-web",
    title: "Qué preguntar antes de contratar un desarrollador web en Colombia",
    metaDescription:
      "8 preguntas clave para hacerle a cualquier desarrollador web antes de contratarlo: dominio, soporte, pagos, seguridad y SEO — sin necesidad de saber programar.",
    excerpt:
      "No necesitás saber programar para contratar bien. Estas son las preguntas que separan a un profesional serio de alguien que solo te va a entregar un archivo.",
    publishedAt: "2026-08-21",
    content: [
      { type: "p", text: "Contratar a alguien para crear la página web de tu negocio no debería reducirse a preguntar cuánto cuesta." },
      {
        type: "p",
        text: "El precio importa, claro, pero hay preguntas mucho más importantes que pueden ayudarte a entender qué estás contratando, quién se hará responsable del proyecto y qué pasará después de que la página esté publicada.",
      },
      { type: "p", text: "Y no necesitás saber programar para hacerlas." },
      {
        type: "p",
        text: "De hecho, un profesional debería poder responderlas de una manera que puedas entender sin necesidad de hablar de código, servidores o términos técnicos complicados.",
      },
      { type: "p", text: "Estas son algunas de las preguntas que yo haría antes de contratar a un desarrollador web." },

      { type: "h2", text: "1. ¿El dominio, el hosting y la página van a quedar a mi nombre?" },
      { type: "p", text: "Esta es una de las primeras preguntas que deberías hacer." },
      {
        type: "p",
        text: "Tu página web forma parte de los activos digitales de tu negocio. Por eso es importante saber quién tendrá el control del dominio, dónde estará alojada la página y qué acceso vas a tener cuando el proyecto esté terminado.",
      },
      { type: "p", text: "Preguntá directamente:" },
      { type: "p", text: "**¿El dominio queda registrado a nombre de mi negocio?**" },
      { type: "p", text: "**¿Voy a tener acceso al hosting?**" },
      { type: "p", text: "**¿Voy a recibir los accesos necesarios cuando termine el proyecto?**" },
      { type: "p", text: "También es importante preguntar por el código fuente y por los archivos del proyecto cuando corresponda." },
      {
        type: "p",
        text: "En Jherva, considero importante que el cliente tenga claridad sobre lo que está adquiriendo. Una página web no debería convertirse en algo que solamente puede manejar el desarrollador que la creó.",
      },

      { type: "h2", text: "2. ¿Qué pasa después de que me entreguen la página?" },
      { type: "p", text: "Esta pregunta suele olvidarse." },
      {
        type: "p",
        text: "Muchas personas piensan únicamente en el momento en que la página queda publicada, pero una web puede necesitar cambios, actualizaciones, correcciones o mantenimiento posteriormente.",
      },
      { type: "p", text: "Por eso podés preguntar:" },
      { type: "p", text: "**¿Qué soporte ofrecen después de la entrega?**" },
      { type: "p", text: "**¿Las correcciones están incluidas?**" },
      { type: "p", text: "**¿Qué pasa si dentro de tres meses necesito cambiar una sección?**" },
      { type: "p", text: "**¿El mantenimiento tiene un costo adicional?**" },
      { type: "p", text: "No existe una única respuesta correcta para todos los proyectos." },
      {
        type: "p",
        text: "Lo importante es que el profesional te explique claramente qué incluye el servicio y qué ocurre cuando necesitás algo que no estaba contemplado inicialmente.",
      },
      {
        type: "p",
        text: "En Jherva, por ejemplo, diferenciamos el desarrollo inicial de los trabajos posteriores que puedan surgir. Así el cliente sabe desde el principio qué está contratando y qué podría requerir un nuevo presupuesto.",
      },

      { type: "h2", text: "3. ¿La página se va a desarrollar realmente para mi negocio?" },
      { type: "p", text: "Esta pregunta es especialmente importante porque actualmente existen muchas herramientas que permiten crear páginas rápidamente." },
      {
        type: "p",
        text: "Y utilizar una plantilla, un CMS, componentes existentes o herramientas de desarrollo no significa automáticamente que el resultado sea malo.",
      },
      { type: "p", text: "El problema aparece cuando simplemente se toma una estructura genérica y se cambia el logo, los colores y algunos textos sin pensar realmente en el negocio." },
      { type: "p", text: "Por eso podés preguntar:" },
      { type: "p", text: "**¿Cómo van a adaptar la página a las necesidades de mi negocio?**" },
      { type: "p", text: "**¿Qué partes serán personalizadas?**" },
      { type: "p", text: "**¿Cómo van a definir la estructura de la página?**" },
      { type: "p", text: "Un buen desarrollo no consiste solamente en hacer que una página se vea bonita." },
      {
        type: "p",
        text: "Antes de escribir código debería existir una idea clara de qué necesita la página, qué información debe mostrar y qué debería hacer una persona cuando llegue a ella.",
      },
      { type: "p", text: "Una web para un hotel no tiene las mismas necesidades que una web para una barbería, un restaurante o una tienda." },
      { type: "p", text: "La tecnología puede ser similar." },
      { type: "p", text: "La solución no debería serlo." },

      { type: "h2", text: "4. ¿Cómo funcionan los pagos?" },
      { type: "p", text: "Antes de comenzar también deberías entender exactamente cómo se va a pagar el proyecto." },
      { type: "p", text: "No solamente preguntes:" },
      { type: "p", text: "**¿Cuánto cuesta?**" },
      { type: "p", text: "Preguntá también:" },
      { type: "p", text: "**¿Cuánto debo pagar inicialmente?**" },
      { type: "p", text: "**¿Cuándo se paga el resto?**" },
      { type: "p", text: "**¿Qué incluye cada etapa?**" },
      { type: "p", text: "**¿Qué ocurre si el proyecto se detiene antes de terminar?**" },
      { type: "p", text: "**¿Qué pasa si aparecen cambios que no estaban contemplados?**" },
      { type: "p", text: "Esto evita uno de los problemas más comunes en cualquier proyecto: que el cliente y el desarrollador tengan expectativas diferentes." },
      {
        type: "p",
        text: "Por ejemplo, en Jherva podemos trabajar con [pagos divididos por etapas](/precios), de manera que exista claridad sobre cuándo comienza el proyecto y cómo se completa el pago.",
      },
      { type: "p", text: "Lo importante no es copiar la forma de pago de otra empresa." },
      { type: "p", text: "Lo importante es que ambas partes sepan desde el principio cómo funciona." },

      { type: "h2", text: "5. ¿La página estará optimizada para celulares?" },
      { type: "p", text: "Esta pregunta parece básica, pero sigue siendo fundamental." },
      { type: "p", text: "Tu página no debería estar pensada únicamente para verse bien en un computador." },
      { type: "p", text: "Una persona puede entrar desde un celular mientras está buscando tu negocio, revisando tus servicios o intentando contactarte." },
      { type: "p", text: "Por eso preguntá:" },
      { type: "p", text: "**¿La página será responsive?**" },
      { type: "p", text: "**¿Cómo se verá en celulares y tablets?**" },
      { type: "p", text: "**¿Se probará en diferentes tamaños de pantalla?**" },
      { type: "p", text: "Una página que funciona correctamente en computador pero tiene problemas en celular puede terminar perdiendo oportunidades de contacto." },

      { type: "h2", text: "6. ¿Qué van a hacer para que la página cargue rápido?" },
      { type: "p", text: "La velocidad también importa." },
      { type: "p", text: "Una página puede tener un diseño excelente y aun así ofrecer una mala experiencia si tarda demasiado en cargar." },
      { type: "p", text: "Podés preguntar:" },
      { type: "p", text: "**¿Cómo van a optimizar las imágenes?**" },
      { type: "p", text: "**¿Van a optimizar el código y los recursos de la página?**" },
      { type: "p", text: "**¿Van a revisar el rendimiento antes de entregarla?**" },
      { type: "p", text: "No necesitás entender exactamente cómo funciona cada optimización." },
      { type: "p", text: "Lo importante es que el desarrollador pueda explicarte qué medidas piensa tomar para que la página tenga un buen rendimiento." },

      { type: "h2", text: "7. ¿La página tendrá una configuración básica de SEO?" },
      { type: "p", text: "No hace falta convertir esta pregunta en una clase de posicionamiento web." },
      { type: "p", text: "Simplemente preguntá qué aspectos básicos de SEO se van a tener en cuenta durante el desarrollo." },
      { type: "p", text: "Por ejemplo:" },
      {
        ...
        items: [
          ...
          "Velocidad de carga.",
          "Etiquetas y estructura HTML adecuadas.",
          "Configuración de elementos técnicos necesarios para que los buscadores puedan interpretar el sitio.",
        ],
      },
      { type: "p", text: "Y algo importante:" },
      { type: "p", text: "**tener una página optimizada para SEO no significa que automáticamente va a aparecer en la primera posición de Google.**" },
      { type: "p", text: "El SEO es un trabajo que puede continuar después del desarrollo." },

      { type: "h2", text: "8. ¿Cómo van a manejar la seguridad?" },
      { type: "p", text: "No necesitás saber de servidores para hacer esta pregunta." },
      { type: "p", text: "Podés preguntar simplemente:" },
      { type: "p", text: "**¿Qué medidas de seguridad tendrá la página?**" },
      {
        type: "p",
        text: "Dependiendo del proyecto, esto puede incluir aspectos como HTTPS, protección de accesos, actualizaciones, copias de seguridad o configuraciones adecuadas del servidor y de las herramientas utilizadas.",
      },
      { type: "p", text: "Un desarrollador serio debería poder explicarte qué medidas aplican al proyecto que está construyendo." },

      { type: "h2", text: "La pregunta que yo siempre haría" },
      { type: "p", text: "Si tuviera que elegir una sola pregunta para hacerle a un desarrollador, sería esta:" },
      { type: "p", text: "**\"¿Qué pasa si después de que me entregues la página necesito cambiar algo que no estaba contemplado inicialmente?\"**" },
      { type: "p", text: "Me gusta porque obliga a hablar de algo que muchas veces queda en el aire." },
      { type: "p", text: "¿Qué pasa con los cambios?" },
      { type: "p", text: "¿Quién los hace?" },
      { type: "p", text: "¿Cuáles están incluidos?" },
      { type: "p", text: "¿Cuáles tienen un costo adicional?" },
      { type: "p", text: "¿Cómo se calcula ese costo?" },
      { type: "p", text: "Un profesional debería poder explicarte esto sin problema." },
      { type: "p", text: "No necesariamente tiene que decirte que todos los cambios son gratis." },
      { type: "p", text: "De hecho, sería poco realista." },
      { type: "p", text: "Lo importante es que exista claridad." },

      { type: "h2", text: "No necesitás saber programar para hacer buenas preguntas" },
      { type: "p", text: "Este es probablemente el punto más importante." },
      { type: "p", text: "Cuando contratás un desarrollador web, no tenés que convertirte en desarrollador para saber si el proyecto está bien planteado." },
      { type: "p", text: "Tu trabajo es entender qué estás comprando." },
      {
        type: "p",
        text: "Podés preguntar quién será dueño del dominio, qué acceso vas a tener, qué incluye el precio, qué ocurrirá después de la entrega, cómo se manejarán los cambios y qué aspectos técnicos va a tener en cuenta el proyecto.",
      },
      { type: "p", text: "Y si el profesional puede explicártelo de forma clara, sin esconderse detrás de palabras técnicas, ya tenés una señal importante." },

      { type: "h2", text: "Conclusión" },
      { type: "p", text: "Contratar un desarrollador web no debería sentirse como comprar algo que no entendés." },
      { type: "p", text: "No necesitás conocer HTML, CSS, JavaScript, servidores o bases de datos." },
      { type: "p", text: "Necesitás hacer las preguntas correctas." },
      {
        type: "p",
        text: "Preguntá quién tendrá el control del dominio y del hosting. Preguntá qué ocurre después de la entrega. Preguntá cómo se manejarán los cambios. Preguntá qué incluye el precio y cómo se realizará el pago.",
      },
      { type: "p", text: "Y preguntá cómo se piensa trabajar aspectos como velocidad, seguridad, SEO y adaptación a celulares." },
      { type: "p", text: "Un profesional no debería molestarse porque hagas estas preguntas." },
      { type: "p", text: "Debería estar preparado para responderlas." },
      { type: "p", text: "Porque una página web no debería ser simplemente algo que alguien te entrega y desaparece." },
      { type: "p", text: "Debería ser una herramienta que entendés, podés administrar y que está construida para cumplir un objetivo real dentro de tu negocio." },
      {
        type: "p",
